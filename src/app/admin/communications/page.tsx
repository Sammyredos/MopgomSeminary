...
export default function CommunicationsPage() {
  ...
  const allowedRoles = ['Super Admin', 'Principal', 'Admin', 'Department Head', 'Manager', 'Instructor', 'Staff']
