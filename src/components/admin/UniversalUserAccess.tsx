...
export function UniversalUserAccess({ className = '', variant = 'button' }: UniversalUserAccessProps) {
  ...
  if (variant === 'compact') {
    return (
      <div className={`flex items-center space-x-2 ${className}`} suppressHydrationWarning={true}>
        <Button
          variant="outline"
          size="sm"
  ...
  if (variant === 'full') {
    return (
      <div className={`space-y-4 ${className}`} suppressHydrationWarning={true}>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-4" suppressHydrationWarning={true}>
          <div className="flex items-center justify-between mb-3" suppressHydrationWarning={true}>
