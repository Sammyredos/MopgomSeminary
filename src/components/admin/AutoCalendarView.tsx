...
export function AutoCalendarView({ events, onEventClick, onDateClick }: AutoCalendarViewProps) {
      ...
      <CardHeader className="pb-4">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          <CardTitle className="flex items-center gap-2">
            ...
            <span className="hidden sm:inline">Auto Calendar</span>
            <span className="sm:hidden">Auto Cal</span>
          </CardTitle>
