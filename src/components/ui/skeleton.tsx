...
function DashboardContentSkeleton() {
  return (
    <div className="space-y-6" suppressHydrationWarning={true}>
        ...
        {Array.from({ length: 4 }).map((_, i) => (
          <div key={i} className="p-6 rounded-lg border bg-card shadow-sm" suppressHydrationWarning={true}>
            <div className="flex items-center justify-between" suppressHydrationWarning={true}>
              <div className="space-y-2 flex-1" suppressHydrationWarning={true}>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-4 gap-6" suppressHydrationWarning={true}>
        ...
        <div className="xl:col-span-2">
          <div className="rounded-lg border bg-card p-6 shadow-sm">
            ...
            <div className="space-y-4" suppressHydrationWarning={true}>
              {Array.from({ length: 5 }).map((_, i) => (
                <div key={i} className="flex items-center space-x-4 p-3 rounded-lg border" suppressHydrationWarning={true}>
                  <Skeleton className="h-10 w-10 rounded-full" />
                  <div className="flex-1 space-y-2" suppressHydrationWarning={true}>
                    <Skeleton className="h-4 w-32" />
                    <Skeleton className="h-3 w-48" />
                  </div>
                  <Skeleton className="h-6 w-16" />
        ...
        <div>
          <div className="rounded-lg border bg-card p-6 shadow-sm">
            ...
            <div className="space-y-3" suppressHydrationWarning={true}>
              {Array.from({ length: 3 }).map((_, i) => (
                <div key={i} className="flex items-start space-x-3 p-3 rounded-lg border" suppressHydrationWarning={true}>
                  <Skeleton className="h-8 w-8 rounded-full" />
                  <div className="flex-1 space-y-2" suppressHydrationWarning={true}>
                    <Skeleton className="h-4 w-3/4" />
                    <Skeleton className="h-3 w-1/2" />
