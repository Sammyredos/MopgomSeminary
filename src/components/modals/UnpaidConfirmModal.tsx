...
import { AlertTriangle, User, Mail, Calendar, Loader2 } from 'lucide-react'
...
export function UnpaidConfirmModal({
  isOpen,
  onClose,
  onConfirm,
  registration,
  loading = false
}: UnpaidConfirmModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md md:max-w-lg p-0 overflow-hidden">
        <div className="bg-gradient-to-br from-amber-50 to-yellow-50 p-4 sm:p-6 border-b border-amber-100">
          <div className="flex items-center space-x-3 sm:space-x-4">
            ...
            <div>
              <h3 className="font-apercu-bold text-lg sm:text-xl text-gray-900">Mark Student as Unpaid</h3>
              <p className="font-apercu-regular text-sm text-gray-600">
                Disable access to course pages and student portal until payment.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="p-4 sm:p-6 space-y-6">
          ...
          <div className="bg-amber-50 border border-amber-200 rounded-lg p-4">
            <p className="font-apercu-regular text-sm text-amber-700">
              Marking as unpaid will immediately restrict the student's access to course pages.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3 pt-4 border-t border-gray-100">
            ...
            <Button onClick={onConfirm} disabled={loading} className="flex-1 bg-amber-600 hover:bg-amber-700 font-apercu-medium text-white">
              {loading ? (
                <>
