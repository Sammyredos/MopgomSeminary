  ...
  useEffect(() => {
    ...
    const setInitialFavicon = () => {
      ...
      if (cachedLogoUrl && cachedLogoUrl !== 'null') {
        ...
        const defaultIcon = 'data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><circle cx="50" cy="50" r="40" fill="%234f46e5"/><text x="50" y="60" text-anchor="middle" fill="white" font-size="40" font-family="Arial">S</text></svg>'
